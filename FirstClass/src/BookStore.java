/*This is a simple program to sell a book (from three specific books) to a customer (from three
...
public class BookStore {
	...
	// calculates price for specific customers and returns the price to showPrice()
	...
	// displays the price that is calculated in the calculatePrice()
	static void showPrice(double price) {
		prln("Your total payable amount: " + price);
		prln("\n-------------THANK YOU FOR SHOPPING FROM OUR BOOKSTORE-------------");
	}
	
	// This method prints anything that is used as an argument with a return at the end 
	static void prln(Object anyObject) {
		System.out.println(anyObject);
	}
	
	// This method prints anything that is used as an argument without a return at the end
